// ============ 自定义 JS 控件渲染器 ============
//
// 纯内容组件 — 卡片 chrome (节点框/端口/删除按钮/编辑入口) 由 WidgetNode 提供。
//
...
/// 节点内嵌 iframe 高度 (原 WidgetNode 传入的 height 缺省值)
const EMBEDDED_HEIGHT = 140;
...
export const CustomWidget = memo(function CustomWidget({ widget }: CustomWidgetProps) {
