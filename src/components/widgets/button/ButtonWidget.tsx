...
// 按下发送 pressValue, 释放发送 releaseValue; 当前值通过 setInputValue
// 推送到后端图 (事件驱动, 供下游 widget 读取)。
...
export const ButtonWidget = memo(function ButtonWidget({ widget }: ButtonWidgetProps) {
