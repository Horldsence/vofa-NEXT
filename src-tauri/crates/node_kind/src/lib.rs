...
//!
//! 模块:
//! - [`NodeKind`][]: 节点种类 (Transport/Protocol/ProtocolSource/Input/Math/Str/
//!   Custom/Filter/SpectrumSink/Ifft/FrameDecoder/Sink/Trigger/TextInput)
//! - [`NodeDef`][]: 节点定义 (含 id/tab_id/kind)
//! - [`PortDomain`]: 端口域 (Bytes / F32 / String) — 用于边分类
//! - [`MathOp`][]: 算术运算种类
