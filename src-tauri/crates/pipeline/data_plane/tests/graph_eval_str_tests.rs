...
use data_plane::{evaluate_snapshot_now, frame_dispatch, DataPlaneState};
use engine::CompiledGraph;
use kind::{MathOp, NodeDef, NodeKind, StrNumParams, StrOp};
    ...
    let graph = CompiledGraph::compile(
        ...
        vec![
            ...
            NodeDef {
                id: "tout".into(),
                tab_id: "t1".into(),
                kind: kind::NodeKind::TextOut {
                    target_transport: "tp1".into(),
                    newline: kind::NewlineMode::Lf,
                    min_interval_ms: 20,
                },
            },
        ],
